const projectsData = [
    ...
    singleProject: [
      {
        ...
        development: [
          ...
          },
          {
            ...
            content:
              "The process of building a functional website involved implementing all the plugins that our team planned to use and outputting the plugins correctly onto the web application. The process also involved checking for proper semantics for every element in the web application.",
            screenshot: "",
          },
          {
            title: "Styling",
            content:
              "The styling process involved checking for reused components and splitting the tasks into reused components. By splitting the tasks into reused components allows for consistency and eliminates any redundant work.",
          },
          {
            title: "Takeaways",
            content:
  ...
  },
  {
    ...
    shortSummary:
      "Portfolio project was developed to showcase my skills as a developer. This project was developed using React and Sass.",
